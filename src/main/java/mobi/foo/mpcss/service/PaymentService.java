...
import mobi.foo.mpcss.dto.request.PaymentRequest;
import mobi.foo.mpcss.dto.response.PaymentResponse;
import mobi.foo.mpcss.entity.MpcssTransaction;
import mobi.foo.mpcss.entity.MpcssTransaction.Direction;
import mobi.foo.mpcss.producer.MpcssResponseProducer;
import mobi.foo.mpcss.repository.TransactionRepository;
...
public class PaymentService {
    ...
    public void handlePaymentStatusReport(String originalMsgId, String status,
        ...
        transactionRepository.findByMessageId(originalMsgId).ifPresentOrElse(txn -> {
            ...
            var statusReport = new mobi.foo.mpcss.dto.PaymentStatusReport();
            statusReport.setOriginalMessageId(originalMsgId);
            statusReport.setGroupStatus(mobi.foo.mpcss.enums.PaymentStatus.fromCode(status));
    ...
    private String buildPacs008Xml(String messageId, String creationDateTime, PaymentRequest request) {
        ...
        return """
                <Document xmlns="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.05">
                  <FIToFICstmrCdtTrf>
                    ...
                    <CdtTrfTxInf>
                      ...
                      <SplmtryData>
                        <PlcAndNm>ACHSupplementaryData</PlcAndNm>
                        <Envlp>
                          <achSupplementaryData>
                ...
                properties.getDefaults().getBatchSource(),
                properties.getDefaults().getSessionSequence()
        );
    }
